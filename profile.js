...
const people = {
  en: {
    ...
    list: [
      ...
      ['guangyan-zhang', 'Dr. Guangyan Zhang', 'Alumni Placeholder', 'guangyan@alumni.example', 'https://images.unsplash.com/photo-1566492031773-4f4e44671857?auto=format&fit=crop&w=480&q=80', 'This is a placeholder alumni profile. Confirmed alumni information will be updated later.', ['Computer networks', 'Distributed systems', 'Systems evaluation'], ['Placeholder entry for alumni research output']],
  ...
  zh: {
    ...
    list: [
      ...
      ['guangyan-zhang', '张光彦 博士', '毕业生占位模板', 'guangyan@alumni.example', 'https://images.unsplash.com/photo-1566492031773-4f4e44671857?auto=format&fit=crop&w=480&q=80', '这是毕业生占位模板，确认后的毕业生信息后续更新。', ['计算机网络', '分布式系统', '系统评测'], ['毕业生研究成果占位条目']],
